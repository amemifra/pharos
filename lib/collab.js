...
let state = { helia: null, orbitdb: null, db: null, started: false, announceTimer: null, error: null };
...
export async function stopCollab() {
  ...
  replicas.clear();
  state = { helia: null, orbitdb: null, db: null, started: false, announceTimer: null, error: null, starting: null };
}
