 ...
 * @property {"music"|"podcast"} medium Content medium — chips and badges read
 *   this field (only existing media are ever shown; "podcast" comes from the
 *   RSS/adapter layer, lib/podcast.js).
