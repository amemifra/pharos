 ...
 *     (proportional alignment; WASM silence-detection is now real —
 *     lib/silence.js: detectSilenceBoundaries(), wasm mask + JS fallback).
...
/**
 * Upgraded from the declared stub: real WASM silence-detection boundary finder
 * lives in lib/silence.js (compact in-repo wasm byte module + JS fallback).
 * When detection yields no usable boundaries, callers keep the proportional
 * estimate. KEEP THE CONTRACT.
 */
export { detectSilenceBoundaries } from "./silence.js"; // real wasm/JS DSP (lib/silence.js)
