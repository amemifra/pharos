...
export function loadPolicy() {
  ...
  // Default "auto" (defect #21): bandwidth-adaptive ceiling instead of blind
  // "best" — FLAC on a 2G radio is a stall, not a feature. Policy already
  // saved above keeps its own mode.
  return { mode: "auto", ceiling: 7, manual: null };
}
